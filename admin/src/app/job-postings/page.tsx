...
//       const resp = await fetch(`${API_BASE_URL}/jobs/positions/${encodeURIComponent(id)}`, {
//         method: "DELETE",
//         headers,
//       });
...
//         };
//         const resp = await fetch(`${API_BASE_URL}/jobs/positions/${encodeURIComponent(draft.id)}`, {
//           method: "PUT",
//           headers,
